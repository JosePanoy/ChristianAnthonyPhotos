...
function Component2() {
    ...
    return (
        <animated.div
            className="component2-container"
            ...
            <animated.div className="component2-bottom-row">
                ...
                <animated.div className="component2-right-box">
                    <animated.p style={{ ...fadeInLeft2, textAlign: 'center' }}>
                        <strong>A former member of Ilo-ilo Sepak Takraw Legendary Striker</strong>
                    </animated.p>
                    <animated.p style={{ ...fadeInLeft2, textAlign: 'center' }}>
                        <strong>One of the Best Spiker in Ilo-ilo Western Visayas</strong>
                    </animated.p>
                    <animated.p style={{ ...fadeInLeft2, textAlign: 'center' }}>
